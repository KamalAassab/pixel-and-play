...
const nextConfig = {
  ...
  images: {
    ...
    minimumCacheTTL: 86400, // 1 day (allows for image updates while still caching)
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://maps.googleapis.com https://www.google-analytics.com https://api.whatsapp.com",
